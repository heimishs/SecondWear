  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto px-4 py-6">
      ...
      <div className="mt-4 bg-white rounded shadow-sm p-4">
        ...
        {/* 버튼을 감싸는 div에 flex + justify-end 적용 */}
        <div className="mt-2 flex justify-end">
          <button
            onClick={handleReviewSubmit}
            className="px-4 py-2 bg-[#E0E97D] text-[#757944] text-sm rounded hover:bg-indigo-700 transition"
          >
            등록
          </button>
        </div>
      ...
      {/* 카드 레이아웃 예시 (모바일 1열, 태블릿 2열, PC 3열) */}
