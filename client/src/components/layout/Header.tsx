...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-full max-w-[1200px] h-[80px] mx-auto px-6 flex justify-between items-center bg-white relative">
      <Link to="/" className="text-2xl font-bold" >헌옷이</Link>

      <nav className="hidden md:flex space-x-6">
        <ul className="flex space-x-6 text-lg font-medium">
          <li><Link to="/Search" className="hover:text-gray-600">수거함정보</Link></li>
          ...
          <li><Link to="/login" className="hover:text-gray-600 ml-10 font-bold">로그인</Link></li>
          <li><Link to="/signup" className="hover:text-gray-600 font-bold">회원가입</Link></li>
        </ul>
      </nav>
